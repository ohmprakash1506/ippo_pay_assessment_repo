...
var user_model_1 = __importDefault(require("../dbconfig/model/user.model"));
...
var UserService = /** @class */ (function () {
    function UserService() {
        ...
        this.create = function (data) { return __awaiter(_this, void 0, void 0, function () {
            var password, saltRound, encryptPassword, hashedPassword, userData, error_1, status, message;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        hashedPassword = encryptPassword.toString();
                        userData = {
                            name: data.name,
                    ...
                    case 3:
                        ...
                        message = "Somthing went wrong in storing the data";
                        return [2 /*return*/, (0, APIResponseHandler_1.returnError)(status, message)];
                    case 4: return [2 /*return*/];
                }
            });
        }); };
        this.getUser = function (data) { return __awaiter(_this, void 0, void 0, function () {
            var userCheck, error_2, status, message;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
        ...
        this.getUserId = function (data) { return __awaiter(_this, void 0, void 0, function () {
            var id, error_4, statusCode, message;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 2:
                        ...
                        message = "Somthing went wrong";
                        return [2 /*return*/, (0, APIResponseHandler_1.returnError)(statusCode, message)];
                    case 3: return [2 /*return*/];
                }
            });
        }); };
        this.updateUser = function (id, data) { return __awaiter(_this, void 0, void 0, function () {
            var filter, update, error_5, status, message;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 2:
                        error_5 = _a.sent();
                        status = http_status_codes_1.default.BAD_REQUEST;
                        message = "Somthing went wrong in update";
                        return [2 /*return*/, (0, APIResponseHandler_1.returnError)(status, message)];
                    case 3: return [2 /*return*/];
                }
            });
